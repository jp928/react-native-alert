...
public class ReactNativeAlertModule extends ReactContextBaseJavaModule implements LifecycleEventListener {
    ...
    ReactNativeAlertModule(ReactApplicationContext context) {
        super(context);
    }
  ...
  @Override
    ...
    public void onHostResume() {
      ...
      if (fragmentManagerHelper != null) {
        ...
        FLog.w(ReactNativeAlertModule.class, "onHostResume called but no FragmentManager found");
      }
    }
